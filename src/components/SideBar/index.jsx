...
const groups = [
  ...
  },
  {
    ...
    options: [
      { text: "View all posts", url: "/landlord", icon: <ListOutlined /> },
      { text: "Create new post", url: "/landlord/publish", icon: <NoteAddOutlined /> },
      { text: "View pending posts", url: "/landlord/pending", icon: <PendingActionsOutlined /> },
    ],
  },
];
